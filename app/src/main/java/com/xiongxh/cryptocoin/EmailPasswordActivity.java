        ...
        mAuth.signInWithEmailAndPassword(email,password).addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if(task.isSuccessful()) {
                    Toast.makeText(EmailPasswordActivity.this, "Success", Toast.LENGTH_SHORT).show();
                    startActivity(new Intent(EmailPasswordActivity.this , CoinDetailActivity.class));
                }else
                    Toast.makeText(EmailPasswordActivity.this, "Auth Fail", Toast.LENGTH_SHORT).show();
